...
public class RequestTwo extends Activity implements CompoundButton.OnCheckedChangeListener{

    ListView listView;
    List<SaborPizza> list = new ArrayList<>();

    ListViewAdapterTwo versionAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.ListRequest2Sabor1);
        ...
        versionAdapter = new ListViewAdapterTwo(RequestTwo.this,R.layout.item_row,list);
