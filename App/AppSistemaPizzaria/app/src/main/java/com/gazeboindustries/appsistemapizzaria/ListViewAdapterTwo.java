...
public class ListViewAdapterTwo extends ArrayAdapter<SaborPizza> {
    Context context;
    List<SaborPizza> list = new ArrayList<>();


    public ListViewAdapterTwo(@NonNull Context context, int resource, List<SaborPizza> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.checkBox.setOnCheckedChangeListener((RequestTwo)context);
