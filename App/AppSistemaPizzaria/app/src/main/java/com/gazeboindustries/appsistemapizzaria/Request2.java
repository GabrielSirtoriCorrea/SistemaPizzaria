...
public class Request2 extends Activity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        versionAdapter = new ListViewAdapter(Request2.this,R.layout.item_row,list);
